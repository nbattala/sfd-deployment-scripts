...
imagePullSecrets=sas-image-pull-secrets-khk78b8597
...
kind: Job
metadata:
    name: modify-internal-postgres-data
spec:
  template:
    spec:
      imagePullSecrets:
      ...
      containers:
      - name: postgres
        image: sasfdacr.azurecr.io/viya-4-x64_oci_linux_2-docker/sas-crunchy5-postgres:1.3.5-20241206.1733500290858
        command: ["bash", "-c"]
        args:
        - |
